<template>
    <main id="home">
        <section class="shapes" @click="regenerateShapes">
        ...
        >
            <div class="container">
                <div class="impression__contents">
                    <h1>Hi, I'm Kolby.</h1>
                    <p class="impression__summary">
                        I'm a {{ age }} year old designer & developer from
                        Vermont. I create noteworthy, performant, and custom
                        websites.
                    </p>
                    <div class="buttons">
                        <nuxt-link
    ...
    methods: {
        ...
        regenerateShapes() {
            ...
            for (let i = 0; i < shapeCount; i++) {
                ...
                shape.classList.add(
                    shapeOptions[
                        Math.floor(Math.random() * shapeOptions.length)
                    ]
                )
                shape.setAttribute(
                    'data-rotation',
