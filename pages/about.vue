<template>
  <main>
    <PageHeading
      heading="about me"
      summary="My name is Kolby Kruger and I'm a 27 year old designer + developer from Vermont."
    />
    ...
    <article>
      ...
      <section class="about about__greeting" ref="aboutGreeting">
        <div class="about__container">
          <div class="about__heading">
            <h2 class="font-size__3">
              {{ $prismic.asText(doc.data.greeting[0].title) }}
              <span class="about__period">.</span>
            </h2>
          </div>
      ...
      <section class="about about__process" ref="aboutProcess">
        <div class="about__container">
          <div class="about__heading">
            <h2 class="font-size__3">
              {{ $prismic.asText(process.data.name) }}
              <span class="about__period">.</span>
            </h2>
          </div>
          <div class="about__contents">
      ...
      <section class="about about__work" ref="aboutWork">
        <div class="about__container">
          <div class="about__heading">
            <h2 class="font-size__3">
              {{ $prismic.asText(doc.data.work[0].title) }}
              <span class="about__period">.</span>
            </h2>
          </div>
          <div class="about__contents">
      ...
      <section class="about about__background" ref="aboutBackground">
        <div class="about__container">
          <div class="about__heading">
            <h2 class="font-size__3">
              {{ $prismic.asText(doc.data.background[0].title) }}
              <span class="about__period">.</span>
            </h2>
          </div>
          <div class="about__contents">
