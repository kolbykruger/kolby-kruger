    ...
    <div class="img">
        <figure v-if="valid" :style="skeleton">
            <picture>
                ...
                />
                <source
                    :data-srcset="sizes.tv.dpr1 + ' 1x,' + sizes.tv.dpr2 + ' 2x'"
...
export default {
    ...
    mounted() {
        ...
        this.sizes.desktop.dpr2 =
            this.src.url + '&dpr=2&w=' + desktop + customProps
